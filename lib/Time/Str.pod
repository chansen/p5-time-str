...
Four-digit years are used as-is. The C<Z> designator is required.
...
Always produces UTC with C<Z> designator:

  time2str(1735052445, format => 'RFC5545')
  # '20241224T153045Z'

B<Limitations>: Fractional seconds and timezone offsets are not supported.
The C<offset> parameter is ignored; formatting always produces UTC.
